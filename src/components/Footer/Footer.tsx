      ...
      <div className="container">
        ...
        <div className={styles.footerBottom}>
          ...
          <div className={styles.socialIcons}>
            <a href="https://wa.me/902164917671" target="_blank" rel="noopener noreferrer" className={styles.socialIcon} title="WhatsApp" style={{'--hover-color': '#25D366'} as any}>
            ...
            <a href="#" target="_blank" rel="noopener noreferrer" className={styles.socialIcon} title="X" style={{'--hover-color': '#FFFFFF'} as any}>
