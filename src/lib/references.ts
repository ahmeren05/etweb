...
export const allReferences: ReferenceItem[] = [
  ...
  { name: 'Gaziantep Üniv. - Proton Hızlandırma', imgUrl: '/references/11- gaziantep üniversitesi proton hızlandırma.png', sectorTr: 'Kamu / Eğitim', sectorEn: 'Public / Education', color: '#103060', tags: ['gaziantep', 'üniversitesi', 'proton', 'hızlandırma', 'kamu', 'eğitim'] },
